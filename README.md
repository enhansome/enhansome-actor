...
Inspired by [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,269 | 🐛 105 | 📅 2026-08-21, [awesome-dotnet](https://github.com/quozd/awesome-dotnet) ⭐ 21,580 | 🐛 145 | 📅 2026-03-26, [awesome-dotnet-core](https://github.com/thangchung/awesome-dotnet-core) ⭐ 21,373 | 🐛 212 | 🌐 C# | 📅 2026-02-27.
...
* [Microsoft Orleans](https://github.com/dotnet/orleans) ⭐ 10,851 | 🐛 685 | 🌐 C# | 📅 2026-08-29 - Orleans is a cross-platform framework for building robust, scalable distributed applications
...
* [CAF: C++ Actor Framework](https://github.com/actor-framework/actor-framework) ⭐ 3,432 | 🐛 58 | 🌐 C++ | 📅 2026-08-29 - CAF is an open source C++11 actor model implementation featuring lightweight & fast actor implementations, pattern matching for messages, network transparent messaging, and more.
